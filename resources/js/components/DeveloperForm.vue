<template>
  <div>
    ...
    >
      <div class="flex flex-wrap -mx-3 mb-6">
        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
          ...
          <input
            ...
            placeholder="Jon"
          />
          <p v-if="errors.first_name" class="text-red-500 text-xs italic">
            {{ errors.first_name[0] }}
          </p>
        </div>
        <div class="w-full md:w-1/2 px-3">
          ...
          <input
            ...
            placeholder="Doe"
          />
          <p v-if="errors.last_name" class="text-red-500 text-xs italic">
            {{ errors.last_name[0] }}
          </p>
        </div>
      </div>
      ...
      <div class="flex flex-wrap -mx-3 mb-6">
        <p v-if="errors.skills" class="text-red-500 text-xs italic">
          {{ errors.skills[0] }}
        </p>
        <div
